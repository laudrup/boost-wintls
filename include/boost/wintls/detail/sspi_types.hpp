...
typedef void(SEC_ENTRY* SEC_GET_KEY_FN)(void* Arg, void* Principal, uint32_t KeyVer, void** Key, SECURITY_STATUS* Status);

typedef SECURITY_STATUS(SEC_ENTRY* ENUMERATE_SECURITY_PACKAGES_FN_A)(uint32_t* pcPackages, PSecPkgInfoA* ppPackageInfo);
typedef SECURITY_STATUS(SEC_ENTRY* ENUMERATE_SECURITY_PACKAGES_FN_W)(uint32_t* pcPackages, PSecPkgInfoW* ppPackageInfo);
...
typedef SECURITY_STATUS(SEC_ENTRY* QUERY_CREDENTIALS_ATTRIBUTES_FN_A)(PCredHandle phCredential, uint32_t ulAttribute, void* pBuffer);
typedef SECURITY_STATUS(SEC_ENTRY* QUERY_CREDENTIALS_ATTRIBUTES_FN_W)(PCredHandle phCredential, uint32_t ulAttribute, void* pBuffer);
...
typedef SECURITY_STATUS(SEC_ENTRY* QUERY_CONTEXT_ATTRIBUTES_FN_A)(PCtxtHandle phContext, uint32_t ulAttribute, void* pBuffer);
typedef SECURITY_STATUS(SEC_ENTRY* QUERY_CONTEXT_ATTRIBUTES_FN_W)(PCtxtHandle phContext, uint32_t ulAttribute, void* pBuffer);
...
typedef SECURITY_STATUS(SEC_ENTRY* MAKE_SIGNATURE_FN)(PCtxtHandle phContext, uint32_t fQOP, PSecBufferDesc pMessage, uint32_t MessageSeqNo);
...
typedef SECURITY_STATUS(SEC_ENTRY* EXPORT_SECURITY_CONTEXT_FN)(PCtxtHandle phContext,
                                                               uint32_t fFlags,
...
typedef SECURITY_STATUS(SEC_ENTRY* ENCRYPT_MESSAGE_FN)(PCtxtHandle phContext,
                                                       uint32_t fQOP,
                                                       PSecBufferDesc pMessage,
                                                       uint32_t MessageSeqNo);
...
SECURITY_STATUS SEC_ENTRY EnumerateSecurityPackagesA(uint32_t* pcPackages, PSecPkgInfoA* ppPackageInfo);
SECURITY_STATUS SEC_ENTRY EnumerateSecurityPackagesW(uint32_t* pcPackages, PSecPkgInfoW* ppPackageInfo);
...
SECURITY_STATUS SEC_ENTRY AcquireCredentialsHandleA(SEC_CHAR* pszPrincipal,
                                                    SEC_CHAR* pszPackage,
                                                    uint32_t fCredentialUse,
                                                    void* pvLogonID,
                                                    void* pAuthData,
                                                    ...
                                                    PCredHandle phCredential,
                                                    PTimeStamp ptsExpiry);
SECURITY_STATUS SEC_ENTRY AcquireCredentialsHandleW(SEC_WCHAR* pszPrincipal,
                                                    SEC_WCHAR* pszPackage,
                                                    uint32_t fCredentialUse,
                                                    void* pvLogonID,
                                                    void* pAuthData,
...
SECURITY_STATUS SEC_ENTRY ExportSecurityContext(PCtxtHandle phContext, uint32_t fFlags, PSecBuffer pPackedContext, void* pToken);
...
SECURITY_STATUS SEC_ENTRY QueryCredentialsAttributesA(PCredHandle phCredential, uint32_t ulAttribute, void* pBuffer);
SECURITY_STATUS SEC_ENTRY QueryCredentialsAttributesW(PCredHandle phCredential, uint32_t ulAttribute, void* pBuffer);

/* Context Management */

SECURITY_STATUS SEC_ENTRY AcceptSecurityContext(PCredHandle phCredential,
                                                PCtxtHandle phContext,
                                                PSecBufferDesc pInput,
                                                uint32_t fContextReq,
                                                uint32_t TargetDataRep,
...
SECURITY_STATUS SEC_ENTRY InitializeSecurityContextA(PCredHandle phCredential,
                                                     PCtxtHandle phContext,
                                                     SEC_CHAR* pszTargetName,
                                                     uint32_t fContextReq,
                                                     uint32_t Reserved1,
                                                     ...
                                                     uint32_t* pfContextAttr,
                                                     PTimeStamp ptsExpiry);
SECURITY_STATUS SEC_ENTRY InitializeSecurityContextW(PCredHandle phCredential,
                                                     PCtxtHandle phContext,
                                                     SEC_WCHAR* pszTargetName,
                                                     uint32_t fContextReq,
                                                     uint32_t Reserved1,
...
SECURITY_STATUS SEC_ENTRY QueryContextAttributes(PCtxtHandle phContext, uint32_t ulAttribute, void* pBuffer);
SECURITY_STATUS SEC_ENTRY QuerySecurityContextToken(PCtxtHandle phContext, void* phToken);
SECURITY_STATUS SEC_ENTRY SetContextAttributes(PCtxtHandle phContext, uint32_t ulAttribute, void* pBuffer, uint32_t cbBuffer);
SECURITY_STATUS SEC_ENTRY RevertSecurityContext(PCtxtHandle phContext);

/* Message Support */

SECURITY_STATUS SEC_ENTRY DecryptMessage(PCtxtHandle phContext, PSecBufferDesc pMessage, uint32_t MessageSeqNo, uint32_t* pfQOP);
SECURITY_STATUS SEC_ENTRY EncryptMessage(PCtxtHandle phContext, uint32_t fQOP, PSecBufferDesc pMessage, uint32_t MessageSeqNo);
SECURITY_STATUS SEC_ENTRY MakeSignature(PCtxtHandle phContext, uint32_t fQOP, PSecBufferDesc pMessage, uint32_t MessageSeqNo);
SECURITY_STATUS SEC_ENTRY VerifySignature(PCtxtHandle phContext, PSecBufferDesc pMessage, uint32_t MessageSeqNo, uint32_t* pfQOP);
